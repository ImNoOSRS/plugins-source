...
public class HiddenSettingsPlugin extends Plugin
{
	@Inject
	private Client client;

	@Inject
	private HiddenSettingsConfig config;

	@Provides
	HiddenSettingsConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(HiddenSettingsConfig.class);
	}
	...
	private void onConfigChanged(ConfigChanged event)
	{
		if (event.getGroup().equals("openosrs"))
		{
			...
			{
				case "mirrorMode":
					client.setMirrored(config.mirrorMode());
					break;
				case "bootstrapMode":
				case "askMode":
